...
REDDIT_CLIENT_ID = os.getenv("ioPeG4fM7RwnJq8Pk_eGsg")
REDDIT_CLIENT_SECRET = os.getenv("sk9QuDvq66p2CeBPaktx79KEuMtakw")
REDDIT_USER_AGENT = os.getenv("Python:NarrativeNexus:v1.0 by u/aditya11001kr")
NEWS_API_KEY = os.getenv("73d030f49baa4e33b3391bae5bcf5724")


reddit = praw.Reddit(
    client_id="ioPeG4fM7RwnJq8Pk_eGsg",
    client_secret="sk9QuDvq66p2CeBPaktx79KEuMtakw",
    user_agent="Python:NarrativeNexus:v1.0 by u/aditya11001kr"
)
